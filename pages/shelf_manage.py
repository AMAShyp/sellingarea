...
def shelf_manage_tab():
    ...
    try:
        ...
        st.write("DEBUG: all_items shape:", all_items.shape)
        st.write("DEBUG: all_items head:", all_items.head())

        if all_items.empty:
            st.error("No items found in database. Please check your data source!")
            return
        ...
        st.write("DEBUG: missing_items shape:", missing_items.shape)
        st.write("DEBUG: editable_items shape:", editable_items.shape)
